...
# -*- coding: utf-8 -*-
#
# widget documentation build configuration file
#
...
_version_py = os.path.join(repo, 'widget', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'widget.tex', 'widget Documentation',
     'Gergo Miklos', 'manual'),
]
